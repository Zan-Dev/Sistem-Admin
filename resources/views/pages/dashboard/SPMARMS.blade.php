    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">SPMARMS</li>
        </ol>
      </nav>
    </div>
                    ...
                    <div class="container-flex">
                      <div class="signup-content">                
                        <div class="signup-form">
                          <form action="{{ route('SPMARMSDownload') }}" method="POST" class="register-form" id="register-form">   
                            @csrf
                            <h2>Susrat Pernyataan Menggunakan Alamat Rumah Milik Sendiri</h2>                          
