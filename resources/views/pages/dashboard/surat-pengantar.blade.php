                    ...
                    <div class="container-flex">
                      <div class="signup-content">                
                        <div class="signup-form">
                          <form action="{{ route('SuratPengantarDownload') }}" method="POST" class="register-form" id="register-form">   
                            @csrf
                            ...
                            <div class="form-group-full">
                                ...
                                <input type="text" name="keperluan" id="keperluan" list="keperluanlist" required/>
                                <datalist id="keperluanlist">
                                    <option value="Mengurus KK">
                                    <option value="Mengurus E-KTP">
                                    <option value="Mengurus Akta Kelahiran">
                            ...
                            <div class="form-group-full">
                                ...
                                <datalist id="keteranganList">
                                    ...
                                    <option value="Melaporkan telah kehilangan E-KTP">
                                    <option value="Melaporkan telah kehilangan E-KTP dan KK">
                                    <option value="Melaporkan telah kehilangan Akta Kelahiran">
                                    <option value="Melaporkan telah kehilangan Surat Nikah">
                                    <option value="Melaporkan telah kehilangan ATM Kartu Tani">
                                    <option value="Melaporkan telah kehilangan E-KTP, SIM, ATM, STNK, dan Kartu Tani">
                                    <option value="Melaporkan telah kehilangan kwitansi perhiasan kalung beserta liontin PUSAKA MAS">
                                    <option value="Mengajukan permohonan boro kawin ke">
                                    <option value="dan berdomisili di Desa Manggungmangu Kecamatan Plantungan">                                    
                                    <option value="dan warga tersebut termasuk warga yang kurang mampu (SKTM)">                                    
                                    <option value="Kartu Keluarga (KK) sedang dalam proses">                                    
                                    <option value="Mengajukan permohonan penerbitan duplikat Surat Kelahiran dari KUA">                                    
